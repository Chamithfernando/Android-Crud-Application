...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    //this method is created for adding Student to the database.
    ...
    //this method is created for displaying specific Student from the list.
    public StudentModel getStudent(int id) {
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.query(TABLE_NAME, new String[]{ID, name, email, phone, dob, created_at}, ID + " = ?",
    ...
    public List<StudentModel> getAllStudents() {
        ...
        if (cursor.moveToFirst()) {
            do {
                StudentModel studentModel = new StudentModel(cursor.getString(0), cursor.getString(1), cursor.getString(2), cursor.getString(4),
